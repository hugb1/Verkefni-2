    ...
    <body>
        ...
        <section class="infoSection">
        	<div class="skraLokidInfo">
        		<p class="skraningTokstTexti">Skráning ${banquet.getName()} tókst!</p>
        		<p class="idTexti">ID númerið þitt er: ${banquet.getId()}</p>
        		<p class="takkFyrirTexti">Takk fyrir að velja Salir.com</p>
        	</div>
        </section>
