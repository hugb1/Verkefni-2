...
nav ul a {
		...
		<body>		
			<header id="header">
			<div class="innertube">
				<h1><center>Bókun á Íþróttasal</center></h1>
			</div>
		</header>
...
<nav id="nav">
	<div class="innertube">
		<h2>Upplýsingar um íþróttasalinn</h2>
			<ul>
			<h4>Nafn: ${sportvenues.getName()}</h4>
			<h4>Gata: ${sportvenues.getAddress()}</h4>
			<h4>Verð: ${sportvenues.getPrice()} kr.</h4>
			<h4>Sími: ${sportvenues.getPhonenr()}</h4>
			<h4>Mail: ${sportvenues.getEmail()}</h4>
			</ul>
	</div>
</nav>
